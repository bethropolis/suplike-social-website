  ...
  <div class="container-lg" >    
    ...
    <?php
     require 'inc/post.inc.php';  
      ...
      echo '</div> ';
      if (!empty($row['image'])){  
      echo '<img class="post_image" src="img/'.$row['date_of_upload'].'">';  
...
<!--  ----------------------------------------------------------------this is the 3rd view or something nimefikiria tu kuongeza-------------------------------------- -->
 <div class="col-sm-2" >
 ...
 <script>
 	...
 	var y = document.getElementById('time_posted')
         ...
         $('#image_post').attr("src", m); 
          ...
          if (!this.classList.contains(`fa-${this.id}`)){   
          $(this).attr('class', `fa fa-${this.id} icon-click like fa-2x`);
          $(this).css('color', 'var(--ho)'); 
          ...
          $(this).attr('class', ` fa fa-${this.id}-o icon-click like fa-2x`);  
          $(this).css('color', '');    
         }
      });       
 	  }); 
