          ...
          datasets: [
            {
              label: "total",
              data: [
                this.day("Sunday", type),
                this.day("Monday", type),
                this.day("Tuesday", type),
                this.day("Wednesday", type),
                this.day("Thursday", type),
                this.day("Friday", type),
                this.day("Saturday", type),
              ],
        ...
        case 4:
          setTimeout(() => {
            ...
            this.doughnut(
              ...
              [this.likes, this.share, this.comments],
