...
<body> 
    <header>
        ...
        <a href=""> 
         <img title="bethlton" src="img/logo.png" alt="logo">    
        </a> 
        ...
        <ul class="navbar-nav ml-auto mr-1"> 
          <a href="index.php"><i title="home" class="fa fa-home fa-2x"></i></a>
          <a href="index.php"><i title="friends" class="fa fa-users fa-2x"></i></a>    
          <a href="profile.php"><i title="direct inbox" class="fa fa-envelope fa-2x"></i></a>    
          <a href=""><i title="follow me on twitter" class="fa fa-twitter fa-2x" ></i></a>
          <a href=""><i title="settings" class="fa fa-cog fa-2x"></i></a>  
